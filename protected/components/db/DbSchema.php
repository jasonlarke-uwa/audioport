...
*/
	...
	{
		if(($duration=$this->_connection->schemaCachingDuration)>0 && $this->_connection->schemaCacheID!==false && ($cache=Core::app()->getComponent($this->_connection->schemaCacheID))!==null)
		{
