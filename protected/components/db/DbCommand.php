...
class DbCommand
{
	...
	public function prepare() {
		if($this->_statement==null) {
			try {
				...
				throw new Exception('DbCommand failed to prepare the SQL statement: ' . $e->getMessage());
			}
		}
	}
	...
	public function execute($params=array())
	{
		...
		catch(Exception $e)
		{
			...
			throw new Exception('DbCommand failed to execute the SQL statement: ' . $message);
		}
	}
